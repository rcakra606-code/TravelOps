  ...
  app.use(helmet({
    ...
    contentSecurityPolicy: {
      ...
      directives: {
        ...
        imgSrc: ["'self'", 'data:', 'blob:', "https://*.basemaps.cartocdn.com", "https://*.tile.openstreetmap.org", "https://images.unsplash.com"],
        connectSrc: ["'self'", "https://cdn.jsdelivr.net", "https://cdnjs.cloudflare.com", "https://fonts.googleapis.com", "https://fonts.gstatic.com", "https://*.basemaps.cartocdn.com", "https://*.tile.openstreetmap.org"],
        objectSrc: ["'none'"],
        frameAncestors: ["'none'"],
        baseUri: ["'self'"],
        formAction: ["'self'"],
